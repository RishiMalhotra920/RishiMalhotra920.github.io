...
start_jekyll() {
    ...
    bundle install
    echo "Starting Jekyll server with development config..."
    bundle exec jekyll serve --config _config.yml,_config_dev.yml --incremental --watch --port=8080 --host=0.0.0.0 --livereload --livereload-min-delay 0 --force_polling &
}
